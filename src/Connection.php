...
use LaraGram\Database\Connection as BaseConnection;
...
use LaraGram\MongoDB\Concerns\ManagesTransactions;
...
class Connection extends BaseConnection
{
    ...
    private static function lookupVersion(): string
    {
        try {
            try {
                return self::$version = InstalledVersions::getPrettyVersion('laraxgram/mongodb') ?? 'unknown';
