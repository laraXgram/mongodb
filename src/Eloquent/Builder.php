...
use Closure;
use LaraGram\Database\Eloquent\Builder as EloquentBuilder;
...
use LaraGram\MongoDB\Helpers\QueriesRelationships;
use LaraGram\MongoDB\Query\AggregationBuilder;
...
/**
 * @method \LaraGram\MongoDB\Query\Builder toBase()
