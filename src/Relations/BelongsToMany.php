...
use LaraGram\Database\Eloquent\Relations\BelongsToMany as EloquentBelongsToMany;
use LaraGram\Support\Arr;
use LaraGram\MongoDB\Eloquent\Model as DocumentModel;
use Override;
...
class BelongsToMany extends EloquentBelongsToMany
{
    ...
    public function sync($ids, $detaching = true)
    {
        ...
        $current = match (\LaraGram\MongoDB\Eloquent\Model::isDocumentModel($this->parent)) {
    ...
    public function attach($id, array $attributes = [], $touch = true)
    {
        ...
        if (\LaraGram\MongoDB\Eloquent\Model::isDocumentModel($this->parent)) {
    ...
    public function detach($ids = [], $touch = true)
    {
        ...
        assert($query instanceof \LaraGram\MongoDB\Eloquent\Builder);
